...
from openapi_llm.client.openapi import OpenAPIClient, HttpClientError
...
class TestErrorHandling:
    ...
    def test_http_error_handling(self, test_files_path, status_code):
        config = ClientConfig(openapi_spec=create_openapi_spec(test_files_path / "yaml" / "openapi_error_handling.yml"),
